/**
 * Folder aliases the agent passes to `mail_move`, mapped to Graph's
 * well-known folder ids. Three options is deliberate — anything more
 * exotic is a knob the user doesn't need today.
 *
 ...
 * three exposed folder aliases. Used by the `mail_move` tool to
 * validate the agent's input before dispatching to Graph.
 */
